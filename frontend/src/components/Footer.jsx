        ...
        <footer className="bg-gray-900 text-white p-10">
            <div className='flex flex-col sm:justify-between sm:flex-row gap-10 md:gap-50 mb-6'>
                <div className="">
                    ...
                    <p className="text-gray-400">Hunt the Bugs. Claim the Bounty.</p>
                </div>
                <div className="container ">
                    <a href="https://www.linkedin.com/in/mohammad-sameem-728391313/" className="text-gray-400 text-white hover:cursor-pointer">About</a>
            ...
            <span className="text-gray-400 text-md hover:text-white">&copy; 2026 CodeQuest. All rights reserved.</span>
        </footer>
    )
}
